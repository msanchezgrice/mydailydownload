...
export default function TerminalTyping({
  ...
  useEffect(() => {
    if (currentLineIndex >= lines.length) {
      // All lines typed - fire completion + start blinking cursor on last line
      onComplete?.();
  ...
  // Blink cursor for currently typing line
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.08]">
        ...
        <span className="ml-3 text-xs text-[#7A8194] font-mono">
