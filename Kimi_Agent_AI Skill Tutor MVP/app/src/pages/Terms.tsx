      ...
      <div className="max-w-[720px] mx-auto">
        ...
        >
          <Section title="Acceptance">
            By subscribing to or using My Daily Download (mydailydownload.com), you agree
            to these Terms. If you don't agree, please don't use the service.
          </Section>

          <Section title="The service">
            We send a daily, career-personalized AI news briefing by email. A free tier is
            available; a Pro tier may be offered as a paid subscription. Features and
          ...
          <Section title="Content & accuracy">
            ...
            sources. We aim for accuracy and always cite sources, but we don't guarantee
            that any item is complete, current, or error-free, and the content is for
            general information only — not professional, financial, legal, or investment
            advice. Trademarks and articles belong to their respective owners; we link to
            originals and do not claim ownership of third-party content.
          </Section>

          <Section title="Acceptable use">
            Don't misuse the service: no scraping or resale of our content, no attempts to
            disrupt the service, and no unlawful use. We may suspend accounts that violate
            these Terms.
          </Section>
          ...
          <Section title="Disclaimers & liability">
            ...
            permitted by law, My Daily Download is not liable for indirect or consequential
            damages, and our total liability is limited to the amount you paid us in the
            prior 12 months (or $0 for free users).
          </Section>
        ...
        <div className="mt-12 flex gap-6">
          <Link to="/privacy" className="text-sm hover:underline" style={{ color: "var(--accent)" }}>
            Privacy Policy →
          </Link>
        </div>
      </div>
